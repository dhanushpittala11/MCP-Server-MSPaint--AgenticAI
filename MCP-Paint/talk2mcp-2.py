    ...
    try:
        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                system_prompt = f"""You are a an agent executing tasks in iterations.
...
you must complete all the above steps before giving the final answer.
Important rules:
...
Your entire response should be a single line starting with either FUNCTION_CALL: or FINAL_ANSWER:"""
                ...
                query ="""First open Paint. Then draw a rectangle from (780, 380) to (1140, 700), by selecting the rectangle button at the coordinate(640, 109). Finally, calculate the sum of the first 5 fibonacci numbers and add this sum as text inside the rectangle."""
